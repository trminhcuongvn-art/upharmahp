...
```mermaid
graph TD
    A[Nhà máy/Xưởng gia công R&D] --> B(Kênh B2B Trực tiếp)
    A --> C(Kênh B2B2C - Đại lý)
    A --> D(Kênh D2C - Bán lẻ online)
    
    B --> B1[Khu công nghiệp/Nhà máy sản xuất]
    B --> B2[Kho vận/Logistics/Chuyển phát nhanh]
    
    C --> C1[Văn phòng phẩm/Cửa hàng bao bì lẻ]
    C --> C2[Chợ đầu mối đồ nhựa]
    
    D --> D1[Shopee/TikTok Shop - Bán sỉ cho Shop E-com]
```
